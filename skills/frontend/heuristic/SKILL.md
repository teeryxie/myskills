...
**Step 1 — Load the methodology.** Read `../ui-craft/references/heuristics.md` for the full rubric, scoring definitions, design law details, and the required output format. Do NOT invent a new format or a new scale.
