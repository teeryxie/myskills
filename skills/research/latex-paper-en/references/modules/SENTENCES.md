...
```bash
uv run --python 3.10 python scripts/analyze_sentences.py main.tex
uv run --python 3.10 python scripts/analyze_sentences.py main.tex --section introduction --max-words 45 --max-clauses 3
```
