...
**References to read**: `../ui-craft/references/layout.md` (composition patterns), `../ui-craft/references/typography.md` and `../ui-craft/references/color.md` (token naming), plus the project's existing component library (scan before writing).
