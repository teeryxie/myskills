...
4. **Visual weight reduction** — if headings are shouting at weight 800 / 72px / tracking -0.04em, compress: 800 → 600, 72 → 56, -0.04 → -0.02. Don't remove hierarchy; tighten the range. Replace hard drop shadows with ambient + direct (`../ui-craft/references/modern-css.md`) or 1px borders — never both. If every section is full-bleed and high-contrast, let some breathe.
