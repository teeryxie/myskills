...
Make the UI at `$ARGUMENTS` bolder. Load the `ui-craft` skill and read `../ui-craft/references/craft-intent.md`.
...
2. **Raise DESIGN_VARIANCE** by +1–2 (cap 10). Product surfaces: asymmetric offset, stronger metric hierarchy, or display moment in shell. Marketing: stronger hero composition, section rhythm break, or typographic scale — per `../ui-craft/references/craft-intent.md` variance table.
