...
Load `../ui-craft/references/brief.md` for the brief format before proceeding.
...
The file must contain all five sections with the exact headings from `../ui-craft/references/brief.md`. No omissions.
