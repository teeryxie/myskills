...
allowed-tools: Read, Glob, Grep, Bash(uv run *), Bash(xelatex *), Bash(lualatex *), Bash(latexmk *), Bash(bibtex *), Bash(biber *)
---
...
4. Run the requested script (e.g., `uv run --python 3.10 python $SKILL_DIR/scripts/compile.py main.tex`).
