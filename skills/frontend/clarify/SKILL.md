...
**References to read**: `../ui-craft/references/copy.md` (microcopy voice + patterns), `../ui-craft/references/accessibility.md` (error message expectations for screen readers).
