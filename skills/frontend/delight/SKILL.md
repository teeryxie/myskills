...
**References to read**: `../ui-craft/references/motion.md` (Decision Ladder + interaction rules), `../ui-craft/references/copy.md` (microcopy voice), `../examples/animation-storyboard.md` (if multi-stage).
