...
**Step 4 — State list.** Enumerate the states this screen must handle. Point at [../ui-craft/references/state-design.md](../skills/ui-craft/references/state-design.md) for the contracts.
...
- At `CRAFT_LEVEL ≥ 7`, add two more sections:
  - **Motion shape** — which elements enter, in what order, with what stagger. Pick from the duration scale in `../ui-craft/references/motion.md`.
